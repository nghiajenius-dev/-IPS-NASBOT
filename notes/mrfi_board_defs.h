...
/* ------------------------------------------------------------------------------------------------
 *                     GDO0 Pin Configuration (on PB2)
 * ------------------------------------------------------------------------------------------------
 */
#define __mrfi_GDO0_BIT__                     2
#define MRFI_GDO0_BASE                        GPIO_PORTB_BASE
...
#define MRFI_GDO0_INT_VECTOR                  INT_GPIOB
#define MRFI_ENABLE_GDO0_INT()                st( MAP_GPIOIntEnable(MRFI_GDO0_BASE, BV(__mrfi_GDO0_BIT__)); )
#define MRFI_DISABLE_GDO0_INT()               st( MAP_GPIOIntDisable(MRFI_GDO0_BASE, BV(__mrfi_GDO0_BIT__)); )
#define MRFI_GDO0_INT_IS_ENABLED()              ( HWREG(MRFI_GDO0_BASE + GPIO_O_IM) & BV(__mrfi_GDO0_BIT__) )
#define MRFI_CLEAR_GDO0_INT_FLAG()            st( MAP_GPIOIntClear(MRFI_GDO0_BASE, BV(__mrfi_GDO0_BIT__)); )
#define MRFI_GDO0_INT_FLAG_IS_SET()             ( MAP_GPIOIntStatus(MRFI_GDO0_BASE, false) & BV(__mrfi_GDO0_BIT__) )
...
/* ------------------------------------------------------------------------------------------------
 *                     GDO2 Pin Configuration (on PB5)
 * ------------------------------------------------------------------------------------------------
 */
#define __mrfi_GDO2_BIT__                     5
#define MRFI_GDO2_BASE                        GPIO_PORTB_BASE
...
#define MRFI_GDO2_INT_VECTOR                  INT_GPIOB
#define MRFI_ENABLE_GDO2_INT()                st( MAP_GPIOIntEnable(MRFI_GDO2_BASE, BV(__mrfi_GDO2_BIT__)); )
#define MRFI_DISABLE_GDO2_INT()               st( MAP_GPIOIntDisable(MRFI_GDO2_BASE, BV(__mrfi_GDO2_BIT__)); )
#define MRFI_GDO2_INT_IS_ENABLED()             ( HWREG(MRFI_GDO2_BASE + GPIO_O_IM) & BV(__mrfi_GDO2_BIT__) )
#define MRFI_CLEAR_GDO2_INT_FLAG()            st( MAP_GPIOIntClear(MRFI_GDO2_BASE, BV(__mrfi_GDO2_BIT__)); )
#define MRFI_GDO2_INT_FLAG_IS_SET()            ( MAP_GPIOIntStatus(MRFI_GDO2_BASE, false) & BV(__mrfi_GDO2_BIT__) )
...
#define MOD_SPI_CSN_BASE                      GPIO_PORTE_BASE
#define MOD_SPI_CSN_BIT                       0
...
st (                                                                          \
  ...
  {                                                                           \
      ...
      {                                                                       \
                                                                              ...
                                                                              \
  MAP_GPIOIntDisable(MRFI_GDO0_BASE, BV(__mrfi_GDO0_BIT__));               \
  MAP_GPIOIntClear(MRFI_GDO0_BASE, BV(__mrfi_GDO0_BIT__));                 \
